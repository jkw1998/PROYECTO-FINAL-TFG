# =============================================================
# TFG - MODELO IA: LSTM — HORIZONTE T=1h
# =============================================================
...
csv_path = os.path.join(DIR, "lstm_resultados_T1h.csv")
...
fig.suptitle(f"LSTM — T=1h", fontsize=13)
...
plt.tight_layout()
png_path = os.path.join(DIR, "lstm_graficas_T1h.png")
