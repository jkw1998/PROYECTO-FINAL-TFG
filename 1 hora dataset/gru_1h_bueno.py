# =============================================================
# TFG - MODELO IA: GRU — HORIZONTE T=1h
# =============================================================
...
csv_path = os.path.join(DIR, "gru_resultados_T1h.csv")
...
fig.suptitle(f"GRU — T=1h", fontsize=13)
...
plt.tight_layout()
png_path = os.path.join(DIR, "gru_graficas_T1h.png")
