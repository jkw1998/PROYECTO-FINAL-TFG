# =============================================================
# TFG - MODELO IA: MLP — HORIZONTE T=1h
# =============================================================
...
csv_path = os.path.join(DIR, "mlp_resultados_T1h.csv")
...
fig.suptitle(f"MLP — T=1h", fontsize=13)
...
plt.tight_layout()
png_path = os.path.join(DIR, "mlp_graficas_T1h.png")
