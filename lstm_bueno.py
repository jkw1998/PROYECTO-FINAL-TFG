# =============================================================
# TFG - MODELO IA: LSTM (Long Short-Term Memory)
# =============================================================
...
# La LSTM mejora la RNN con memoria a largo plazo mediante
# tres puertas (entrada, olvido, salida), lo que le permite
# capturar relaciones entre horas distantes del dia.
#
...
# --- Arquitectura LSTM ---
# LSTM(4 -> hidden 64, 2 capas) + cabeza 50->80->42->48
...
df_res.to_csv("lstm_resultados.csv", index=False)
...
fig.suptitle("LSTM - Evaluacion", fontsize=13)
...
axes[1].plot(dia0["HORA"], dia0["ACCION_IA"],   label="LSTM", color='darkorange', linestyle='--')
...
axes[2].plot(dia0["HORA"], dia0["SOC_IA"],   label="LSTM", color='darkorange', linestyle='--')
axes[2].set_title("SOC (dia 800)"); axes[2].set_xlabel("Hora"); axes[2].legend(); axes[2].grid(True, alpha=0.4)

plt.tight_layout()
plt.savefig("lstm_graficas.png", dpi=150)
plt.show()