# =============================================================
# TFG - MODELO IA: RNN — HORIZONTE T=2h
# =============================================================
...
csv_path = os.path.join(DIR, "rnn_resultados_T2h.csv")
...
fig.suptitle(f"RNN — T=2h", fontsize=13)
...
plt.tight_layout()
png_path = os.path.join(DIR, "rnn_graficas_T2h.png")
