# =============================================================
# TFG - MODELO IA: GRU — HORIZONTE T=2h
# =============================================================
...
csv_path = os.path.join(DIR, "gru_resultados_T2h.csv")
...
fig.suptitle(f"GRU — T=2h", fontsize=13)
...
plt.tight_layout()
png_path = os.path.join(DIR, "gru_graficas_T2h.png")
