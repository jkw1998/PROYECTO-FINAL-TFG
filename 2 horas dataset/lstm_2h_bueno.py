# =============================================================
# TFG - MODELO IA: LSTM — HORIZONTE T=2h
# =============================================================
...
csv_path = os.path.join(DIR, "lstm_resultados_T2h.csv")
...
fig.suptitle(f"LSTM — T=2h", fontsize=13)
...
plt.tight_layout()
png_path = os.path.join(DIR, "lstm_graficas_T2h.png")
