# =============================================================
# TFG - MODELO IA: LSTM — HORIZONTE T=4h
# =============================================================
# Autor: James Kagunda Wangari
# Grado en Ingenieria Electrica - Universidad de Malaga
#
# LSTM con memoria a largo plazo. Captura relaciones
# entre horas distantes mediante puertas de entrada,
# olvido y salida.
#
# Dataset de entrada:
# -------------------
...
#
# Arquitectura: LSTM: (24,4) -> hidden64 -> 50 -> 80 -> 42 -> 48
...
print(f"LSTM: (24,4) -> hidden64 -> 50 -> 80 -> 42 -> 48")
...
csv_path = os.path.join(DIR, "lstm_resultados_T4h.csv")
...
fig.suptitle(f"LSTM — T=4h", fontsize=13)
...
plt.tight_layout()
png_path = os.path.join(DIR, "lstm_graficas_T4h.png")
