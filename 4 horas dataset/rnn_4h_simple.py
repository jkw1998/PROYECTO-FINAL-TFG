# =============================================================
# TFG - MODELO IA: RNN — HORIZONTE T=4h
# =============================================================
...
csv_path = os.path.join(DIR, "rnn_resultados_T4h.csv")
...
fig.suptitle(f"RNN — T=4h", fontsize=13)
...
plt.tight_layout()
png_path = os.path.join(DIR, "rnn_graficas_T4h.png")
