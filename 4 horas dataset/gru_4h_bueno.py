# =============================================================
# TFG - MODELO IA: GRU — HORIZONTE T=4h
# =============================================================
# Autor: James Kagunda Wangari
# Grado en Ingenieria Electrica - Universidad de Malaga
#
# GRU simplifica la LSTM con dos puertas (actualización
# y reset). Menos parámetros, entrenamiento más rápido
...
#
# Arquitectura: GRU: (24,4) -> hidden64 -> 50 -> 80 -> 42 -> 48
...
csv_path = os.path.join(DIR, "gru_resultados_T4h.csv")
...
fig.suptitle(f"GRU — T=4h", fontsize=13)
...
axes[1].plot(dia0["HORA"], dia0["ACCION_IA"],
             label="GRU", color='darkorange', linestyle='--')
...
plt.tight_layout()
png_path = os.path.join(DIR, "gru_graficas_T4h.png")
